...
CREATE TRIGGER update_attendance_updated_at BEFORE UPDATE ON attendance FOR EACH ROW EXECUTE FUNCTION update_attendance_updated_at_column();
CREATE TRIGGER update_attendance_justifications_updated_at BEFORE UPDATE ON attendance_justifications FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
CREATE TRIGGER update_activity_files_updated_at BEFORE UPDATE ON activity_files FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

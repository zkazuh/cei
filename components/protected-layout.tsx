...
import { Building2, Users, Clock, FileText, LogOut, Menu, X, UserCog, GraduationCap } from "lucide-react"
import Link from "next/link"
import { usePathname } from "next/navigation"
import { useState } from "react"

const navigation = [
  { name: "Dashboard", href: "/ceiromao", icon: Building2 },
  { name: "Employees", href: "/ceiromao/employees", icon: UserCog, adminOnly: true },
  { name: "Attendance", href: "/ceiromao/attendance", icon: Users },
  { name: "Activity Hours", href: "/ceiromao/activity-hours", icon: Clock },
        ...
        <div className="fixed inset-y-0 left-0 flex w-64 flex-col bg-white">
          <div className="flex h-16 items-center justify-between px-4 border-b">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold">Ceiromão</span>
            </div>
